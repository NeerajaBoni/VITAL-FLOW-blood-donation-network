        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
                ...
                <InfoCard title="Verification" icon={<ShieldCheckIcon className="h-6 w-6 mr-3 text-gray-400"/>}>
                    {user.isVerified ? (
                        <Alert type="success" title="Profile Verified" message="Your identity and blood type have been confirmed, building trust in the community." />
                    ) : (
            ...
            {user && <EditProfileModal isOpen={isEditModalOpen} onClose={() => setEditModalOpen(false)} user={user} onSave={handleSaveProfile} />}
